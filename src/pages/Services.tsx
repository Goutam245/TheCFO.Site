...
const services = [
  { id: "bookkeeping-month-end-close", icon: ClipboardList, title: "Bookkeeping & Month-End Close", body: "A fast, accurate close so leadership has the real numbers within days of month-end.", deliverables: ["Bank & credit card reconciliations", "Journal entries and accruals", "Trial balance review"] },
  { id: "financial-reporting", icon: FileBarChart, title: "Financial Reporting", body: "Management reports and Power BI dashboards built around the metrics that matter to your firm.", deliverables: ["Monthly P&L, BS, CF", "Power BI KPI dashboards", "Variance & trend analysis"] },
  { id: "fpa-budgeting-forecasting", icon: LineChart, title: "FP&A / Budgeting / Forecasting", body: "Build the model that makes every major decision easier — staffing, pricing, capital allocation.", deliverables: ["Annual budgets", "Rolling 12-month forecasts", "13-week cash flow"] },
  { id: "controllership-services", icon: ShieldCheck, title: "Controllership Services", body: "Process controls, audit support, and policy design for businesses scaling beyond the founder.", deliverables: ["Internal controls", "Audit / review prep", "GAAP technical accounting"] },
  { id: "strategic-advisory", icon: Sparkles, title: "Strategic Advisory", body: "A partner at the table for the decisions that change the trajectory of your business.", deliverables: ["Board reporting", "Growth & exit strategy", "Pricing & unit economics"] },
  { id: "negotiation-litigation-support", icon: Handshake, title: "Negotiation & Litigation Support", body: "Financial analysis, damages quantification, and expert support for high-stakes negotiations and disputes.", deliverables: ["Financial due diligence", "Damages & loss analysis", "Expert witness support"] },
  { id: "fractional-cfo", icon: Briefcase, title: "Fractional CFO", body: "Senior CFO leadership at a fraction of the cost — embedded in your weekly operating cadence.", deliverables: ["Capital strategy", "Investor & lender relations", "Quarterly board cycle"] },
  { id: "accounts-receivable-payable", icon: ReceiptText, title: "Accounts Receivable & Payable", body: "Tight invoicing, collections, and bill-pay workflows that keep cash moving on time.", deliverables: ["Invoicing & collections", "Bill pay workflows", "Aging report reviews"] },
];
      ...
      <section className="bg-canvas section-pad">
        <div className="container-page">
          ...
          <Stagger className="mt-10 grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {services.map((s) => (
              <StaggerItem key={s.title}>
                <div id={s.id} className="card-warm card-hover p-7 h-full flex flex-col scroll-mt-28">
